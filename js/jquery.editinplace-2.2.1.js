...
$.fn.editInPlace.defaults = {
	...
	bg_out:				"transparent", // string: background color on .targetrestore from hover
...
// Eelco: In latest jQuery versions $.browser is deprecated. The bugs do not appear in later versions.
...
// EELCO: This has a bug. It restores the entered value (instead of reverting to the original value, above)
